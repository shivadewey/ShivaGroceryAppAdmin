...
import com.example.blinkitadmin.databinding.ItemViewOrdersBinding
...
class AdapterOrders(
    ...
    override fun onBindViewHolder(holder: OrdersViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            Navigation.findNavController(it).navigate(R.id.action_orderInformationFragment_to_orderDetailFragment,bundle)
        }
    }
